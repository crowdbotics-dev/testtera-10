"""
Django settings for testtera_10 project.
...
WSGI_APPLICATION = 'testtera_10.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testtera_10 API",
    "DESCRIPTION": "API documentation for testtera_10 App",
    "VERSION": "v1",
}
